...
export function App() {
      ...
      <footer className='flex items-center justify-center border-t border-gray-700/50 bg-[#0b112170] text-white'>
        <div className='flex max-w-7xl flex-grow flex-col gap-5 px-5 py-8'>
          <div className='flex flex-grow justify-between'>
            ...
            <a href='#' className='font-semibold text-white/40 hover:text-white'>
              Visit
            </a>
          </div>
  ...
  // function Footer() {
  //   return (
  //     <footer className='highlight-none bg-hero-pattern-light dark:bg-hero-pattern-dark border-t border-gray-200 bg-gray-50 py-6 dark:border-gray-800 dark:bg-gray-900'>
